    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('reset', SubmitType::class, [
                'label'        => 'Réinitialiser',
                'attr'         => [
                    'class' => 'block justify-center px-4 py-1 text-sm font-medium text-white bg-red-600 border border-transparent rounded-md shadow-sm hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500',
                ],
            ])
        ;
    }
